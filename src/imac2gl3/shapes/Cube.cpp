...
/* FACE AVANT 1 */
	    ...
	    m_pDataPointer[0].texCoords.x = 0.f ;
            m_pDataPointer[0].texCoords.y = 0.5f;
	    ...
	    m_pDataPointer[1].texCoords.x = 0.5f;
            m_pDataPointer[1].texCoords.y = 0.5f;
	    ...
	    m_pDataPointer[2].texCoords.x = 0.5f;
            m_pDataPointer[2].texCoords.y = 0.f;
...
/* FACE AVANT 2 */
	    ...
	    m_pDataPointer[3].texCoords.x = 0.f ;
            m_pDataPointer[3].texCoords.y = 0.5f;
	    ...
	    m_pDataPointer[4].texCoords.x = 0.5f;
            m_pDataPointer[4].texCoords.y = 0.f;
	    ...
	    m_pDataPointer[5].texCoords.x = 0.f;
            m_pDataPointer[5].texCoords.y = 0.f;
...
/* FACE EST 1 */
	    ...
	    m_pDataPointer[6].texCoords.x = 0.5f ;
            m_pDataPointer[6].texCoords.y = 1.f;
	    ...
	    m_pDataPointer[7].texCoords.x = 1.f;
            m_pDataPointer[7].texCoords.y = 1.f;
	    ...
	    m_pDataPointer[8].texCoords.x = 1.f;
            m_pDataPointer[8].texCoords.y = 0.5f;
...
/* FACE EST 2 */
	    ...
	    m_pDataPointer[9].texCoords.x = 0.5f ;
            m_pDataPointer[9].texCoords.y = 1.f;
	    ...
	    m_pDataPointer[10].texCoords.x = 1.f;
            m_pDataPointer[10].texCoords.y = 0.5f;
	    ...
	    m_pDataPointer[11].texCoords.x = 0.5f;
            m_pDataPointer[11].texCoords.y = 0.5f;
...
/* FACE OUEST 1 */
	    ...
	    m_pDataPointer[12].texCoords.x = 0.5f ;
            m_pDataPointer[12].texCoords.y = 1.f;
	    ...
	    m_pDataPointer[13].texCoords.x = 1.f;
            m_pDataPointer[13].texCoords.y = 1.f;
	    ...
	    m_pDataPointer[14].texCoords.x = 1.f;
            m_pDataPointer[14].texCoords.y = 0.5f;
...
/* FACE OUEST 2 */
	    ...
	    m_pDataPointer[15].texCoords.x = 0.5f ;
            m_pDataPointer[15].texCoords.y = 1.f;
	    ...
	    m_pDataPointer[16].texCoords.x = 1.f;
            m_pDataPointer[16].texCoords.y = 0.5f;
	    ...
	    m_pDataPointer[17].texCoords.x = 0.5f;
            m_pDataPointer[17].texCoords.y = 0.5f;
...
/* FACE SUD 1 */
	    ...
	    m_pDataPointer[18].texCoords.x = 0.f ;
            m_pDataPointer[18].texCoords.y = 1.f;
	    ...
	    m_pDataPointer[19].texCoords.x = 0.5f;
            m_pDataPointer[19].texCoords.y = 1.f;
	    ...
	    m_pDataPointer[20].texCoords.x = 0.5f;
            m_pDataPointer[20].texCoords.y = 0.5f;
...
/* FACE SUD 2 */
	    ...
	    m_pDataPointer[21].texCoords.x = 0.f ;
            m_pDataPointer[21].texCoords.y = 1.f;
	    ...
	    m_pDataPointer[22].texCoords.x = 0.5f;
            m_pDataPointer[22].texCoords.y = 0.5f;
	    ...
	    m_pDataPointer[23].texCoords.x = 0.f;
            m_pDataPointer[23].texCoords.y = 0.5f;
...
/* FACE ARRIERE 1 */
	    ...
	    m_pDataPointer[24].texCoords.x = 0.f ;
            m_pDataPointer[24].texCoords.y = 0.5f;
	    ...
	    m_pDataPointer[25].texCoords.x = 0.5f;
            m_pDataPointer[25].texCoords.y = 0.5f;
	    ...
	    m_pDataPointer[26].texCoords.x = 0.5f;
            m_pDataPointer[26].texCoords.y = 0.f;
...
/* FACE ARRIERE 2 */
	    ...
	    m_pDataPointer[27].texCoords.x = 0.f ;
            m_pDataPointer[27].texCoords.y = 0.5f;
	    ...
	    m_pDataPointer[28].texCoords.x = 0.5f;
            m_pDataPointer[28].texCoords.y = 0.f;
	    ...
	    m_pDataPointer[29].texCoords.x = 0.f;
            m_pDataPointer[29].texCoords.y = 0.f;
...
/* FACE NORD 1 */
	    ...
	    m_pDataPointer[30].texCoords.x = 0.f ;
            m_pDataPointer[30].texCoords.y = 1.f;
	    ...
	    m_pDataPointer[31].texCoords.x = 0.5f;
            m_pDataPointer[31].texCoords.y = 1.f;
	    ...
	    m_pDataPointer[32].texCoords.x = 0.5f;
            m_pDataPointer[32].texCoords.y = 0.5f;
...
/* FACE NORD 2 */
	    ...
	    m_pDataPointer[33].texCoords.x = 0.f ;
            m_pDataPointer[33].texCoords.y = 1.f;
	    ...
	    m_pDataPointer[34].texCoords.x = 0.5f;
            m_pDataPointer[34].texCoords.y = 0.5f;
	    ...
	    m_pDataPointer[35].texCoords.x = 0.f;
            m_pDataPointer[35].texCoords.y = 0.5f;
